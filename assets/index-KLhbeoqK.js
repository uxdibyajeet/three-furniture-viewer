...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=mr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=mr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=mr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=mr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case v:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=v;break;case y:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=y;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case v:case y:e.colorSpace=Ve,e.minFilter=l,e.magFilter=l,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Ld=class extends Tn{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new W(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element&&e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},Rd=new G,zd=new J,Bd=new J,Vd=new G,Hd=new G,Ud=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.sortObjects=!0,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),zd.copy(t.matrixWorldInverse),Bd.multiplyMatrices(t.projectionMatrix,zd),l(e,e,t),this.sortObjects&&f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){Rd.setFromMatrixPosition(e.matrixWorld),Rd.applyMatrix4(Bd);let c=Rd.z>=-1&&Rd.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(Rd.x*i+i)+`px,`+(-Rd.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return Vd.setFromMatrixPosition(e.matrixWorld),Hd.setFromMatrixPosition(t.matrixWorld),Vd.distanceToSquared(Hd)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},Wd=0,Gd=[{id:0,name:`Geometric Accent Chair`,description:`Handcrafted with premium ash wood and velvet upholstery. A study in post-modern silhouettes.`,specs:[`W: 75cm`,`D: 80cm`,`H: 95cm`],path:`./models/Chair_01.glb`,visuals:{exposure:.5,bgHex:`#f0f0f0`,envBlur:.25,envIntensity:1,lightIntensity:1}},{id:1,name:`Minimal Chair`,description:`Handcrafted with premium ash wood and velvet upholstery. A study in post-modern silhouettes.`,specs:[`W: 75cm`,`D: 80cm`,`H: 95cm`],path:`./models/Chair_02.glb`,visuals:{exposure:.5,bgHex:`#f0f0f0`,envBlur:.25,envIntensity:1,lightIntensity:1}}],Kd=new Ud;Kd.setSize(window.innerWidth,window.innerHeight);var qd=Kd.domElement.style;qd.position=`absolute`,qd.top=`0`,qd.left=`0`,qd.pointerEvents=`none`,document.body.appendChild(Kd.domElement);var Jd=new Pn,Yd=window.innerWidth,Xd=window.innerHeight,Zd=new cu({antialias:!0});Zd.toneMapping=4,Zd.outputColorSpace=Be,Zd.setSize(Yd,Xd),Zd.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(Zd.domElement);var Qd=new go(75,Yd/Xd,.1,1e3);Qd.position.z=5;var $d=new vu(Qd,Zd.domElement);$d.enableDamping=!0;var ef=new Co(16777215,1);ef.position.set(2,2,5),Jd.add(ef);var tf=new wo(16777215,.8);Jd.add(tf);function nf({exposure:e=1.4,bgHex:t=`#D99D26`,envBlur:n=.5,envIntensity:r=1.2,lightColor:i=16777215,lightIntensity:a=2.5}){Zd.toneMappingExposure=e,Jd.background=new Y(t).convertSRGBToLinear(),Jd.backgroundBlurriness=n,Jd.environmentIntensity=r,ef.color.set(i),ef.intensity=a,tf.color.set(i),tf.intensity=a*.5}new Id().load(`https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/studio_small_08_1k.hdr`,e=>{e.mapping=303,Jd.environment=e;let t=Gd[Wd].visuals;nf(t)});var rf=new Nu;rf.setDecoderPath(`https://www.gstatic.com/draco/versioned/decoders/1.5.7/`);var af=new Lu;af.setDRACOLoader(rf);var of;function sf(){let e=Gd[Wd],t=document.querySelector(`.productTitle`);t&&(t.textContent=e.name),af.load(e.path,e=>{of=e.scene;let t=new Yn().setFromObject(of).getCenter(new G);of.position.y=-1.75,of.scale.set(1.5,1.5,1.5),of.position.x+=of.position.x-t.x,of.position.z+=of.position.z-t.z,Jd.add(of),console.log(`Model Loaded Successfully`),Jd.add(hf),hf.position.set(0,.5,0)})}function cf(){requestAnimationFrame(cf),of&&(of.rotation.y+=25e-5),$d.update(),Zd.render(Jd,Qd),Kd.render(Jd,Qd)}cf(),window.addEventListener(`resize`,()=>{Yd=window.innerWidth,Xd=window.innerHeight,Qd.aspect=Yd/Xd,Qd.updateProjectionMatrix(),Zd.setSize(Yd,Xd),Zd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Kd.setSize(window.innerWidth,window.innerHeight)});function lf(e){let t=Gd[e];if(!t){console.error(`No item found at index:`,e);return}document.querySelector(`.modelTitle`).textContent=t.name,document.querySelector(`.modelDesc`).textContent=t.description;let n=document.querySelector(`.modelSpecs`);n.innerHTML=t.specs.map(e=>`<li>${e}</li>`).join(``),document.querySelector(`.modal`).classList.remove(`hidden`)}function uf(e){Wd=e===`next`?(Wd+1)%Gd.length:(Wd-1+Gd.length)%Gd.length;let t=Gd[Wd];of&&=(ff(of),null),af.load(t.path,e=>{of=e.scene,of.position.y=-1.75,of.scale.set(1.5,1.5,1.5),Jd.add(of),nf(t.visuals);let n=document.querySelector(`.productTitle`);n&&(n.textContent=t.name),console.log(`Switched to: ${t.name}`)})}function df(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.getAttribute(`data-action`);switch(n){case`next`:uf(`next`);break;case`prev`:uf(`prev`);break;case`open-modal`:lf(Wd);break;case`close-modal`:document.querySelector(`.modal`).classList.add(`hidden`);break;default:console.log(`Action not defined:`,n)}}function ff(e){e&&(e.traverse(e=>{if(e.isMesh)if(e.geometry.dispose(),e.material.isMaterial)pf(e.material);else for(let t of e.material)pf(t)}),Jd.remove(e))}function pf(e){e.dispose();for(let t of Object.keys(e))e[t]&&e[t].isTexture&&e[t].dispose()}function mf(){let e=document.createElement(`div`);e.className=`hotspot`,e.textContent=`+`,e.style.pointerEvents=`auto`,e.setAttribute(`data-action`,`open-modal`);let t=new Ld(e);return t.position.set(0,.5,0),t}var hf=mf();document.body.addEventListener(`click`,df),sf();